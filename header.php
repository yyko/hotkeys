					...
					<div id="site-banner-left-inner">
						...
						<?php if ( $logoImg || $blogname ) { ?>
                            <div class="site-branding <?php if ( ! display_header_text() ) { echo 'hide-header-text'; } ?>">
                                <?php if ( true ) : ?>
                                    <h1 class="site-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="http://sedecilliard.com/wp-content/uploads/2016/09/291.png" alt="logo" /></a></h1>
                                <?php else : ?>
